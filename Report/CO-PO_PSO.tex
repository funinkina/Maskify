...
\end{flushleft}
\\
\textbf{C410.1:} Identify, formulate, design, and analyze a research-based or web-based problem.\\
\textbf{C410.2:} Communicate effectively in verbal and written form.\\
\textbf{C410.3:} Apply appropriate computing and engineering skills to solve the formulated problem within the stipulated time.\\
\textbf{C410.4:} Work effectively as part of a team in multidisciplinary areas.\\
...
\cline{2-15}
 &
  ...
  \multicolumn{1}{l|}{\size\textbf{PSO2}} &
