...
\hline
\textbf{Type} & \textbf{T} & \textbf{D} & \textbf{\%} & \textbf{Notes} \\
\hline
Aadhaar & 5 & 5 & 100 & Verhoeff \\
\hline
PAN Card & 4 & 2 & 50 & OCR issue \\
\hline
Payment Card & 3 & 2 & 67 & Luhn \\
\hline
Email & 3 & 3 & 100 & Regex \\
\hline
Phone & 3 & 3 & 100 & Regex \\
\hline
NER Names & 3 & 2 & 67 & BERT \\
\hline
NER Address & 3 & 1 & 33 & Format \\
\hline
\end{tabular}
\end{table}
...
\hline
\textbf{Doc} & \textbf{Type} & \textbf{ms} & \textbf{Det} & \textbf{Notes} \\
\hline
Aadhaar-1 & PNG & 296 & 1 & First OCR \\
\hline
Aadhaar-2 & PNG & 274 & 1 & First OCR \\
\hline
Aadhaar-3 & PNG & 274 & 1 & First OCR \\
\hline
PAN-Card-1 & JPG & 1582 & 0 & No detect \\
\hline
Screenshot & JPG & 304 & 1 & Near target \\
\hline
Credit-Card & PNG & 699 & 0 & Multiple \\
\hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{|l|c|l|c|p{2cm}|}
\hline
\textbf{TC} & \textbf{Input} & \textbf{Expected} & \textbf{Actual} & \textbf{Status} \\
\hline
TC-01 & Clear Aadhaar PNG & One Aadhaar detect. & One Aadhaar & Pass \\
\hline
TC-02 & Single-page PDF & Redaction applied & Redaction applied & Pass \\
\hline
TC-03 & Multiple PII & All types detected & All types & Pass \\
\hline
TC-04 & Partial masking & First 4 chars masked & First 4 chars & Pass \\
\hline
TC-05 & Full masking & All chars masked & All chars & Pass \\
\hline
TC-06 & No-PII doc & Zero detections & Zero & Pass \\
\hline
TC-07 & Invalid Aadhaar & Rejected & Rejected & Pass \\
\hline
TC-08 & NER enabled & Detections returned & Detections & Pass \\
\hline
TC-09 & Word doc & HTTP 400 & HTTP 400 & Pass \\
\hline
TC-10 & Invalid level & HTTP 400 & HTTP 400 & Pass \\
\hline
TC-11 & Corrupted img & HTTP 500 & HTTP 500 & Pass \\
\hline
TC-12 & 90-deg rotated & Detection & Detection & Pass \\
\hline
TC-13 & 180-deg rotated & Detection & Detection & Pass \\
\hline
TC-14 & Upside-down Aadhaar & Detection & Detection & Pass \\
\hline
TC-15 & Std Aadhaar timing & Under 300 ms & 274-296 ms & Pass \\
\hline
TC-16 & No-detection case & Under 2000 ms & 1582 ms & Pass \\
\hline
\end{tabular}
\end{table}
...
\hline
\textbf{Capability} & \textbf{RE-DACT} & \textbf{Adobe} & \textbf{Presidio} & \textbf{Manual} \\
\hline
Aadhaar Verhoeff & Yes & No & Custom & Depends \\
\hline
PAN validation & Yes & No & Custom & Depends \\
\hline
Payment Luhn & Yes & Yes & Yes & Depends \\
\hline
Multi-orientation OCR & Yes & No & No & Depends \\
\hline
Audit metadata & Hash chain & Setup & No & Manual \\
\hline
Local Web API & Yes & No & Yes & No \\
\hline
No persistent storage & Yes (TTL) & Local & Depends & Depends \\
\hline
\end{tabular}
\end{table}
